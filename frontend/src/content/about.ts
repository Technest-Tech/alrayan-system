export const aboutContent = {
  ...
  approach: {
    ...
    subheading:
      'Our methodology is built on three pillars that set us apart from every other online academy.',
    items: [
      {
      ...
      },
      {
        ...
        body: 'Less than 10% of applicants pass our process: degree verification, Tajweed test, live teaching observation, background check, and a 3-month probationary period. We would rather turn away students than lower our standards.',
        icon: 'ShieldCheck',
        stat: '< 10% acceptance rate',
      },
      {
        title: '1-on-1 Private Classes',
        body: 'No group classes. Every student gets their own teacher, their own schedule, and a curriculum paced to their individual level. This is why our completion and satisfaction rates are so high.',
        icon: 'Users',
