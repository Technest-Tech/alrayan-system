...
type SelectProps = Omit<React.ComponentProps<typeof SelectPrimitive.Root>, 'onValueChange' | 'value'> & {
...
function Select({ onValueChange, value, ...props }: SelectProps) {
  return (
    <SelectPrimitive.Root
      ...
      // Always pass a defined string so the component stays controlled.
      // '' means "no selection" — Base UI shows the placeholder when no item matches.
      value={value ?? ''}
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      onValueChange={onValueChange ? ((v: any) => { if (v !== null) onValueChange(v as string) }) as any : undefined}
    />
  )
}
